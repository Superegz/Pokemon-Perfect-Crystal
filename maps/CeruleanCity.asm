...
.MapCallbacks:
	...
	;dbw MAPCALLBACK_OBJECTS, .GuardCheck
...
;.DisappearGuard
	;disappear CERULEANCITY_SLOWBRO
	;return
...
.PersonEvents:
	db 7
	person_event SPRITE_COOLTRAINER_M, 23, 15, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, CooltrainerMScript_0x184010, -1
	...
	person_event SPRITE_COOLTRAINER_M, 14, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BlackBeltScripttext, EVENT_OPENED_MT_SILVER
